...
class BootAnalyzer:
    ...
    def enable_trace(self):
        """Enable disk I/O trace logging.

        Logs seek operations and address/data prolog detections to stdout.
        """
        def trace_cb(msg):
            print(f"  [TRACE] {self.cpu.exec_count:>12,}: {msg}")
        self.disk.trace_callback = trace_cb
