#!/usr/bin/env python3
"""
Decode 5-and-3 sector 0 from track 0 and disassemble as code at $0300.
This is the "stage 2" boot code that the RWTS JMPs to at $0301.
Must match what the $02D1 post-decode produces.
"""
import struct, sys
