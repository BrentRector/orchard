#!/usr/bin/env python3
"""
Decode ALL address fields from Apple Panic WOZ to determine sector ordering.
Then properly reconstruct disk data with correct sector mapping.
"""
import struct
import hashlib
...
def main():
    ...
    # Save ordered image
    out_path = "E:/Apple/ApplePanic_original_ordered.bin"
