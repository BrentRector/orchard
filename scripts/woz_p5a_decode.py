#!/usr/bin/env python3
"""
Correct P5A ROM 5-and-3 byte reconstruction.

Based on actual Apple-II-Disk-Tools nibblize_5_3.c source code.

On-disk order (411 bytes):
...
def main():
    ...
    with open("E:/Apple/track0_p5a.bin", 'wb') as f:
        f.write(t0_image)
    print(f"\nWrote track 0 image to track0_p5a.bin ({len(t0_image)} bytes)")
