...
then apply the $0346 permutation to get the correct memory layout.
...
def main():
    ...
    os.makedirs("E:/Apple/decoded_sectors", exist_ok=True)
    ...
    for sec_num in sorted(sectors.keys()):
        ...
        # Save to file
        fname = f"E:/Apple/decoded_sectors/track00_sec{sec_num:02d}_mem.bin"
    ...
    mem_path = "E:/Apple/decoded_sectors/track0_B600_BFFF.bin"
