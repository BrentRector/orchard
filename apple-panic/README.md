...
| File | Description |
|------|-------------|
| [Walkthrough.md](Walkthrough.md) | **Start here** — step-by-step reverse engineering guide, from WOZ file to assembly source |
...
Rendered from the runtime binary by [`scripts/render_sprites.py`](../scripts/render_sprites.py):

| File | Description |
|------|-------------|
| [`assets/player_sprites.png`](assets/player_sprites.png) | Player character — 5 animation frames (Walk R 1/2, Climb, Dig L 1/2) |
| [`assets/enemy_sprites.png`](assets/enemy_sprites.png) | Enemy types — Apple, Butterfly, Mask × 2 animation frames |
| [`assets/font_icons.png`](assets/font_icons.png) | Score font (digits 0-9) and life icon |
| [`assets/platform_tile.png`](assets/platform_tile.png) | Platform brick tile |
| [`assets/platform_patterns.png`](assets/platform_patterns.png) | Platform tile overlay patterns — AND mask + ORA top/bottom, 8 shift variants |
| [`assets/platform_shifts.png`](assets/platform_shifts.png) | All 8 pre-shifted platform tile variants ($0800-$0950) |
| [`assets/apple_shape.png`](assets/apple_shape.png) | Title screen apple (from title screen code, not runtime binary) |

Each sprite is shown in both monochrome green and Apple II color approximation at 6x scale.
...
| [ApplePanic_GameLoader.asm](ApplePanic_GameLoader.asm) | Game loader + RWTS — $B700-$BFFF, track reading, marker patching |
...
$0301: Stage 2                           → ApplePanic_Boot_Stage2.asm
  ...
  ▼
$B700: Game Loader                       → ApplePanic_GameLoader.asm
