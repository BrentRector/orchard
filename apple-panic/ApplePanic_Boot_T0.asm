...
; sector data that establishes the game loader at $B700.
...
;    $B600-$BFFF, then JMP ($003E) = JMP $B700 (game loader).
...
;   S0  $B600  Stage 2 loader code (copy of $0300-$03FF)
;   S1  $B700  Game loader entry point (checksum OK with bit-doubling)
;   S2  $B800  5-and-3 encode routine + data field writer
;   S3  $B900  Address field search (D5/DE [per-track] B5) + 4-and-4 reader
...
; $B600-$BFFF (see ApplePanic_Boot_Stage2.asm and ApplePanic_GameLoader.asm
...
; Searches for D5 AA AD data prologue, then reads 411 data nibbles
